...
extension UIFont {
    ...
    */
    class func heuristicaRegular(size: CGFloat) -> UIFont{return UIFont(name: "Heuristica-Regular", size: size)!}
    ...
    - parameter size: The size of the font
    */
    class func heuristicaBoldItalic(size: CGFloat) -> UIFont{return UIFont(name: "Heuristica-BoldItalic", size: size)!}
    ...
    - parameter size: The size of the font
    */
    class func heuristicaBold(size: CGFloat) -> UIFont{return UIFont(name: "Heuristica-Bold", size: size)!}
    ...
    - parameter size: The size of the font
    */
    class func heuristicaItalic(size: CGFloat) -> UIFont{return UIFont(name: "Heuristica-Italic", size: size)!}

    /**
    Returns the UIFont for Montserrat-Bold of a particular size
    - parameter size: The size of the font
    */
    class func montserratBold(size: CGFloat) -> UIFont{return UIFont(name: "Montserrat-Bold", size: size)!}
    ...
    - parameter size: The size of the font
    */
    class func montserratRegular(size: CGFloat) -> UIFont{return UIFont(name: "Montserrat-Regular", size: size)!}
