...
- (void)increaseBulkTimerInterval;
- (void)resetBulkTimerInterval;
- (void)setBulkTimerInterval:(int)newValue;
...
#pragma mark iOS8 category handling
-(void)presentDynamicCategoryNotification:(NSDictionary *)userInfo;
-(void)presentNotification: (NSDictionary*)userInfo;
-(NSInteger)findActionIndexForIdentifier:(NSString*)identifier;
-(void)handleAnyNotification:(NSDictionary*)userInfo action:(NSDictionary*)action;
