...
This app uses geofencing capability to monitor a given radius around the gas stations. When a customer enters the area, personlized deals are sent to them using IBM Push notification service.
