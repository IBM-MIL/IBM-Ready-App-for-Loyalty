...
-(void) registerForPushWithCategories:(NSSet*)categories
{
    [self xtLogMessage:XTLOG content:@"Attempt to register for push notifications... with categories %@", categories];
    ...
    if([app respondsToSelector:@selector(registerForRemoteNotifications)])
    {
        ...
        id settings = [UserNotificationSettings settingsForTypes:types categories:categories];
