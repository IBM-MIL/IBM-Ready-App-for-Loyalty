...
/**
 * Java adapter implementation that exposes REST urls that will retrieve 
...
public class LoyaltyUserAdapterResource {
	...
	static Logger logger = Logger.getLogger(LoyaltyUserAdapterResource.class.getName());
	 ...
	 */
	/**
	 * Retrieve the  personality insights for a user. You would normally
	 * take a users Twitter feed and supply it to the  personality
	 ...
	 * are suppling the  service and are NOT using the results to generate
	 ...
	 * 
	 * @return The  personality insights response as a JSON string.
	 */
	 ...
	 * query the  personality insights service.
	 * 
	 * @return An HttpPost object which can be used to query the 
	...
	try {
		builder = new URIBuilder(watsonPath);
		builder.setParameter("version", "2017-10-13");
	...
	/**
	 * Helper method to call out to the  Service to retrieve the
	 * personality insights for the given user characteristics.
	 * 
	 * @param req
	 *            The request we will be submitting to  that contains the
	 *            user characteristics.
	 * @return String representing the reply from the  service.
	 * @throws Exception
	 *             General exception thrown whenever the  service returns
